...
def main(args):
    ...
    # env
    all_args.use_eval = True if all_args.sample_data or all_args.eval_model or all_args.preference_eval else all_args.use_eval
    ...
    if config["all_args"].sample_data:
        runner.sample_data()
    elif config["all_args"].eval_model:
        runner.eval(0)
    elif config["all_args"].pretrain_with_pair:
        runner.pretrain_pair()
    elif config["all_args"].preference_eval:
        runner.preference_eval(0)
    else:
        runner.run()
