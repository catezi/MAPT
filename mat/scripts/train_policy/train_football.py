...
def main(args):
    ...
    if all_args.config_dir:
        run_dir = Path(all_args.log_dir + "/results") / all_args.env_name / all_args.scenario / all_args.algorithm_name / all_args.experiment_name
    else:
    ...
    if all_args.sample_data:
        runner.sample_data(0)
    else:
        runner.run()
