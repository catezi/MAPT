...
class SeparatedReplayBuffer(object):
    def __init__(self, args, obs_space, share_obs_space, act_space, agent_id=0, device='cpu'):
    ...
    def insert(self, share_obs, obs, rnn_states, rnn_states_critic, actions, action_log_probs,
               value_preds, rewards, dones, masks, bad_masks=None, active_masks=None, available_actions=None):
